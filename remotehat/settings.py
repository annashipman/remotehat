# Django settings for remotehat project.
...
if DEBUG:
    SECRET_KEY = '+0!#s=)87$kue8$a34axtgu@hf9axzn02g_mitg^g(czkpl$#f'
else:
...
WSGI_APPLICATION = 'remotehat.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'hat'),
